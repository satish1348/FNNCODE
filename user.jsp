	...
	<div id="page-bgbtm">
		<div id="content">
		  ...
		  <table width="600" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            ...
            <h2 align="right"><a href="U_ImgDetail.jsp" class="style4">Back</a></h2>
			<%}else if(type.equalsIgnoreCase("video")){%>
            <h2 align="right"><a href="U_VidDetail.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("imagedata"))
			{%>
            <h2 align="right"><a href="U_FrdImgVid.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("videodata"))
			{%>
            <h2 align="right"><a href="U_FrdVid.jsp" class="style4">Back</a></h2>
			<%}
