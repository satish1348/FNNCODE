...
<div id="wrapper">
	...
	<div id="page-bgbtm">
		<div id="content">
			...
			<div align="left" class="style3 style4 style14 style7" style="margin-left:20px;">User</div></td>
			<td width="86" height="44" valign="middle" bgcolor="#99FF99" style="color: #2c83b0;">
		...
		<tr>
			...
			<div class="style7" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
			 <input  name="image" type="image" src="images.jsp?id=<%=s4%>&value=<%="image"%>" style="width:50px; height:50px;"  />
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="U_UserProfile.jsp?value=<%=s1%>&type=<%="user11"%>"><%out.println(s1);%></a></div></td>
			   <td  width="109" valign="middle" height="44" style="color:#000000;">
		      <div align="left" class="style6 style10" style="margin-left:20px;"><a href="C_ImageDetail.jsp?title=<%=s2%>&type=<%="user1"%>"><%out.println(s2);%></a></div></td>
