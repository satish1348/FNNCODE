...
<title>Cloud View All Images Ranks </title>
...
<div id="wrapper">
	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				<h2 align="center" class="style5 style3">View all Image Rank Chart Results..</h2>
	  <iframe src="Results.jsp" height="400" width="600"></iframe>
		  <div align="center" class="style51">(<span class="style3"> Number of Times Views</span>)	      </div>
